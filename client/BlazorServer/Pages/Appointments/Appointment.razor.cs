...
public partial class Appointment
{
    ...
    private static Color StatusColor(string s) => s switch // màu hiển thị
    {
    ...
    private const string Completed = "Comleted";
